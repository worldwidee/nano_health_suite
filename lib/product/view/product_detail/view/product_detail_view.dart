            ...
            child: Scaffold(
              ...
              body: Observer(
                builder: (context) => switch (model.serviceStatus) {
                  ...
                  ServiceStatus.success => Stack(children: [
                      Align(
                      ...
                      Align(
                        ...
                        child: Observer(builder: (context) {
                          return AnimatedContainer(
                            ...
                            height: figma.px(
                                model.isOpened ? 355 : 245, Axis.vertical),
                            width: double.infinity,
                            decoration: BoxDecoration(
                                color: appearance.secondaryBgColor,
                                borderRadius: BorderRadius.vertical(
                                    top: Radius.circular(
                                        figma.px(30, Axis.horizontal)))),
                              ...
                              FigmaBox(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    SizedButton(
                                      onPressed: () {},
                                      width: figma.px(56, Axis.horizontal),
                                      height: figma.px(54.76, Axis.vertical),
                                      color: appearance.secondaryBgColor,
                                      radius: 20,
                                      boxShadow: const [
                                        BoxShadow(
                                      ...
                                      child: Image.asset(
                                        IconPaths.share,
                                        color: appearance.primary,
                                        width: figma.px(15.67, Axis.horizontal),
                                      ),
                                    ),
                                    const FigmaBox(
                                      width: 39.17,
